...
export const loadAppConfig = async (url) => {
    ...
    try {
        ...
        appConfig = {
            apiBaseUrl: 'TTK_API_BASE_URL',
            authEnabled: 'TTK_AUTH_ENABLED',
            payeeSimBrandIcon: 'TTK_PAYEE_SIM_BRAND_ICON',
            payerSimBrandIcon: 'TTK_PAYER_SIM_BRAND_ICON'
        };
...
export const getConfig = () => {
    ...
    const isAuthEnabled = `${appConfig.authEnabled}`.toUpperCase() === 'TRUE';
    // Payee Sim Branding
    ...
    if(appConfig.payeeSimBrandIcon && !appConfig.payeeSimBrandIcon.startsWith('TTK')) {
        payeeAppSimulatorBrandConfig.icon = appConfig.payeeSimBrandIcon;
    }
    ...
    if(appConfig.payerSimBrandIcon && !appConfig.payerSimBrandIcon.startsWith('TTK')) {
        payerAppSimulatorBrandConfig.icon = appConfig.payerSimBrandIcon;
    }
