...
class RulesValidation extends React.Component {
  ...
  updateRules = async (newState) => {
    ...
    const { apiBaseUrl } = getConfig()
    await axios.put(apiBaseUrl + '/api/rules/files/validation/' + this.state.selectedRuleFile, newState.curRules, { headers: { 'Content-Type': 'application/json' } })
