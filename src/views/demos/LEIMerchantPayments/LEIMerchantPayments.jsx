...
class LEIMerchantPayments extends React.Component {
  ...
  handleNotificationEvents = event => {
    ...
    if (event.category === 'payerMerchant') {
      if (this.payerMerchantRef.current) { this.payerMerchantRef.current.handleNotificationEvents(event) }
      ...
      if (this.payeeMerchantRef.current) { this.payeeMerchantRef.current.handleNotificationEvents(event) }
      this.updateSequenceDiagram(event)
    } else if (event.category === 'payerMerchantMonitorLog') {
      if (this.payerMerchantMonitorRef.current) { this.payerMerchantMonitorRef.current.appendLog(event.data.log) }
    } else if (event.category === 'payeeMerchantMonitorLog') {
      if (this.payeeMerchantMonitorRef.current) { this.payeeMerchantMonitorRef.current.appendLog(event.data.log) }
